...
# Write from URL
engraver write https://releases.ubuntu.com/22.04/ubuntu.iso /dev/sdb
...
engraver write https://releases.ubuntu.com/22.04/ubuntu-22.04-desktop-amd64.iso /dev/sdb --verify
