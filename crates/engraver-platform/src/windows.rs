...
use windows_sys::Win32::Storage::FileSystem::{
    ...
    FILE_BEGIN, FILE_FLAG_NO_BUFFERING, FILE_FLAG_WRITE_THROUGH, FILE_SHARE_READ,
...
fn get_device_size(handle: HANDLE, _path: &str) -> Result<u64> {
    use windows_sys::Win32::System::Ioctl::{IOCTL_DISK_GET_LENGTH_INFO, GET_LENGTH_INFORMATION};
